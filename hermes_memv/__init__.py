...
融合 memvault v0.1 (SnowHaruna) + Hermes 增强:
  ...
  - 理论: Ebbinghaus 指数衰减 + Sleep Loop 巩固
...
from hermes_memv.config import MemoryVaultConfig, load_config
from hermes_memv.core.engine import MemoryStore
from hermes_memv.core.compressor import MemoryCompressor, create_llm_summarizer
from hermes_memv.core.consolidator import SleepConsolidator
from hermes_memv.core.decay import compute_weight, compute_importance
from hermes_memv.core.formatter import format_system_prompt_block
...
from hermes_memv.llm.mock import MockLLM
from hermes_memv.retrieval.hybrid import HybridRetriever
from hermes_memv.storage.base import AbstractStorage
from hermes_memv.storage.sqlite import SQLiteStorage
from hermes_memv.storage.file import FileStorage
from hermes_memv.storage.memory import MemoryStorage
from hermes_memv.types import (
    ConsolidationResult,
    MemoryEntry,
    MemoryStats,
    SearchResult,
...
class MemoryVault:
    ...
    def remember(self, content: str, target: str = "memory",
        ...
        Args:
            ...
            importance: 手动指定重要性 (0.0-1.0)，None = 自动从情绪+衰减计算

        Returns:
            {"success": bool, "entry_id": str, ...}
        """
        if importance is None:
            importance = emotion_to_importance(content)
